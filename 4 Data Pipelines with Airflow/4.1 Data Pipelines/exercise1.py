...
# Once you’ve done that, run "start.sh" command to start the web server.
...
# If you get stuck, you can take a look at the solution file or the video walkthrough on the next page.
