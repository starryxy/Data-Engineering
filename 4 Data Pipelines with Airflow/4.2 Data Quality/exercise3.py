...
# data has been pre-partitioned in AWS S3 by creation date
# The partition follows the format: <year>/<month>/<day>/<file>.csv
...
copy_trips_task = PythonOperator(
    ...
    # https://airflow.apache.org/docs/stable/_api/airflow/operators/python_operator/index.html
